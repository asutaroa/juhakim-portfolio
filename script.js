const projects = {
  ...
  "chanel-digital": {
    ...
    desc: "샤넬의 브랜드 가치와 공급망 투명성을 디지털 경험으로 전달하는 웹사이트 기획 프로젝트입니다. 브랜드 스토리, 제품 정보, 고객 여정을 하나의 웹 경험으로 연결했습니다.",
    role: "Traceability 리서치, 콘텐츠 기획, 웹사이트 구조 구성",
    takeaway: "럭셔리 브랜드의 디지털 경험은 단순한 정보 전달이 아니라 브랜드의 세계관과 신뢰를 함께 전달해야 한다는 점을 배웠습니다.",
    pdf: "#"
  },
